...
public class EqualizerModel extends Observable
{
     ...
     */
    String path = "/sdcard/AuremReloaded/";
    ...
    public void readLastStateFile()
    {
        ...
        try {
            inputStream = new FileInputStream("/sdcard/AuremReloaded/lastState.txt");
    ...
    public void readPresetFile()
    {
        FileInputStream inputStream;
        try {
            inputStream = new FileInputStream("/sdcard/AuremReloaded/presets.txt");
            inStream = new Scanner(inputStream);
        }
        catch(IOException e) {
            System.out.println(e.getMessage());
